 document.addEventListener('DOMContentLoaded', () => {
  ...
  if (product) {
    ...
    document.getElementById('product-category').textContent = `Category: ${product.category} | ${product.subCategory}`;
    document.getElementById('product-description').textContent = product.description;
    document.getElementById('product-rating').innerHTML = `Rating: ${'★'.repeat(Math.floor(product.rating))} (${product.reviews} reviews)`;
    document.getElementById('product-stock').textContent = product.inStock ? `In Stock: ${product.stockQuantity}` : 'Out of Stock';
    ...
    addToCartBtn.addEventListener('click', () => {
      ...
      showNotification(`Added ${product.name} (${selectedSize}, ${selectedColor}) to cart!`);
      updateCartDisplay();
    });
  } else {
